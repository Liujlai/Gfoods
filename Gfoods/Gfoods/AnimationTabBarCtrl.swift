...
class AnimationTabBarCtrl: UITabBarController {
    
    var iconsView:[(icon: UIImageView, textLabel: UILabel)] = []
    //var iconsImageName:[String] = ["v2_home", "v2_order", "shopCart", "v2_my", "v2_home"]
    //var iconsSelectedImageName:[String] = ["v2_home_r", "v2_order_r", "shopCart_r", "v2_my_r", "v2_home_r"]
    var iconsImageName:[String] = ["v2_home", "v2_order", "v2_home", "shopCart", "v2_my"]
    var iconsSelectedImageName:[String] = ["v2_home_r", "v2_order_r", "v2_home_r", "shopCart_r", "v2_my_r"]
    ...
    func createCustomIcons(_ containers: [String: UIView]) {
        if let items = tabBar.items {
            for (index, item) in items.enumerated() {
                ...
                let icon = UIImageView(frame: CGRect(x: imageX, y: container.tag == 2 ? centerY:imageY, width: container.tag == 2 ? centerW:imageW, height: container.tag == 2 ? centerH:imageH))
